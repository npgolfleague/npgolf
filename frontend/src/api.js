...
export const tournamentsAPI = {
  ...
  create: (date, course_id, number_of_holes, nine_hole_side = 'front', first_tee_time = null, shotgun_start = false) => apiClient.post('/tournaments', { date, course_id, number_of_holes, nine_hole_side, first_tee_time, shotgun_start }),
  update: (id, date, course_id, number_of_holes, nine_hole_side = 'front', first_tee_time = null, shotgun_start = false) => apiClient.put(`/tournaments/${id}`, { date, course_id, number_of_holes, nine_hole_side, first_tee_time, shotgun_start }),
