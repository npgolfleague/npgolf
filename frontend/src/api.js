...
export const tournamentsAPI = {
  ...
  create: (date, course_id, number_of_holes, nine_hole_side = 'front', first_tee_time = null, shotgun_start = false, standard_quota_game = true) => apiClient.post('/tournaments', { date, course_id, number_of_holes, nine_hole_side, first_tee_time, shotgun_start, standard_quota_game }),
  update: (id, date, course_id, number_of_holes, nine_hole_side = 'front', first_tee_time = null, shotgun_start = false, standard_quota_game = true) => apiClient.put(`/tournaments/${id}`, { date, course_id, number_of_holes, nine_hole_side, first_tee_time, shotgun_start, standard_quota_game }),
...
export const scoresAPI = {
  ...
  getCtpAdminOptions: (tournamentId) => apiClient.get(`/scores/tournament/${tournamentId}/ctp-admin-options`),
  updateCtpWinners: (tournamentId, winners) => apiClient.put(`/scores/tournament/${tournamentId}/ctp-winners`, { winners }),
