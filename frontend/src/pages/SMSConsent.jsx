    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">NPGOLF</p>
        </div>
        ...
        <div className="space-y-6 text-gray-700">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p>
                  ...
                  to receive SMS messages from NPGOLF. No messages are sent unless the user actively checks this box.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="border-t pt-6">
            ...
            <div className="bg-gray-100 border border-gray-300 rounded-lg p-6 text-center">
              <img
                src="/sms-opt-in-example.png"
                alt="Registration form showing phone number field and SMS consent checkbox"
